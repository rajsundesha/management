...
//                   Text('Received at: ${_formatDate(request['receivedAt'])}'),
//                 SizedBox(height: 8),
//                 Text('Items:', style: TextStyle(fontWeight: FontWeight.bold)),
//                 ..._buildItemsList(request['items'] ?? []),
//                 SizedBox(height: 8),
...
//             label: Text('Receive'),
//             onPressed: () => _showReceiveDialog(request['id']),
//             style: ElevatedButton.styleFrom(
...
// ${request['approvedAt'] != null ? 'Approved at: ${_formatDate(request['approvedAt'])}\n' : ''}
// ${request['fulfilledAt'] != null ? 'Fulfilled at: ${_formatDate(request['fulfilledAt'])}\n' : ''}
// ${request['receivedAt'] != null ? 'Received at: ${_formatDate(request['receivedAt'])}\n' : ''}
// Items: ${_formatItems(request['items'] ?? [])}
// Note: ${request['note'] ?? 'N/A'}
//   ''';
...
//   void _showReceiveDialog(String id) {
//     showDialog(
//       context: context,
//       builder: (context) => AlertDialog(
//         title: Text('Receive Items'),
//         content:
...
//               if (adminEmail != null) {
//                 Provider.of<RequestProvider>(context, listen: false)
//                     .updateStockRequestStatus(id, 'received', adminEmail)
//                     .then((_) {
//                   Navigator.of(context).pop();
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     SnackBar(content: Text('Items received successfully')),
//                   );
//                 }).catchError((error) {
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     SnackBar(content: Text('Error receiving items: $error')),
//                   );
//                 });
//               } else {
//                 ScaffoldMessenger.of(context).showSnackBar(
