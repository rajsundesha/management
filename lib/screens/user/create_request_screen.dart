...
//                 onPressed: () {
//                   setState(() {
//                     if (_selectedItems[item['name']]!['quantity'] == 1) {
//                       _selectedItems.remove(item['name']);
//                     } else {
...
//               ),
//               Text(
//                   '${_selectedItems[item['name']]!['quantity']} ${item['unit']}'),
//               IconButton(
//                 icon: Icon(Icons.add),
//                 onPressed: () {
//                   setState(() {
...
//         itemBuilder: (context, index) {
//           String itemName = _selectedItems.keys.elementAt(index);
//           int quantity = _selectedItems[itemName]!['quantity'];
//           return Consumer<InventoryProvider>(
//             builder: (context, inventoryProvider, child) {
//               Map<String, dynamic> item = inventoryProvider.items
//                   .firstWhere((element) => element['name'] == itemName);
...
//           onPressed: () {
//             setState(() {
//               if (_selectedItems[itemName]!['quantity'] == 1) {
//                 _selectedItems.remove(itemName);
//               } else {
...
//             ),
//             controller: TextEditingController()
//               ..text = _selectedItems[itemName]!['quantity'].toString(),
//           ),
//         ),
//         IconButton(
//           icon: Icon(Icons.add),
...
//                   SnackBar(
//                     content: Text(
//                         'Request added for ${_selectedItems.entries.map((e) => '${e.value['quantity']} x ${e.key}').join(', ')} at $location'),
//                   ),
//                 );
